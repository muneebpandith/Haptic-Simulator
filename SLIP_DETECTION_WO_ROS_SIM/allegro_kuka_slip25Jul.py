...
while t < T:
	...
	if t > ITERATIONS_PICKUP_COMPLETE:
		#print('yes')
		#This triggers slip
		joint_cmd[19] = joint_cmd[19] - 5*delta
		joint_cmd[28] = joint_cmd[28] - 5*delta
		#This triggers slip
	
		

	#joint_cmd[19] = joint_cmd[37] - 10*delta
	...
	#save_to_csv(FILENAME,['PICKUP_IN_PROGRESS',x_ti           me ]+get_joint_states_hand_only( kuka_allegro_hand_biotac, numJoints),'a')
	t += 1
