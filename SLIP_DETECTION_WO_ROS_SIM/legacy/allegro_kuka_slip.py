...
FILENAME = 'TRACE_SLIP_SLIPPING_INSTANCE.csv'
...
# In[333]:
for _ in range(100):
    save_to_csv(FILENAME,['STABLE_AFTER_GRASPING',datetime.now().time() ]+get_joint_states_hand_only( kuka_allegro_hand_biotac, numJoints),'a')
