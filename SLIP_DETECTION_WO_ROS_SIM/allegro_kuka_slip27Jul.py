...
global joint_cmd
global cube_big
global kuka_allegro_hand_biotac, numJoints, planeId, physicsClient

def reset_env(gravity_arg):
	#Setup environment
	global kuka_allegro_hand_biotac, numJoints, planeId, physicsClient
	global joint_cmd
	...
	while detected is False:
		...
		if t < ITERATIONS_PICKUP_COMPLETE: #only pickup
			...
			if detected == False:
				...
				#slip using all joints of robotic hand
				joint_cmd[17] = joint_cmd[17] - delta2/100
				joint_cmd[18] = joint_cmd[18] - delta2/1000
				joint_cmd[19] = joint_cmd[19] - delta2/10000
				
				joint_cmd[26] = joint_cmd[26] - delta2/100
				joint_cmd[27] = joint_cmd[27] - delta2/1000
				joint_cmd[28] = joint_cmd[28] - delta2/10000
			...
			slip_status, ts_slip = check_slip_vanilla_distance(Z0,Z, init_time)
			#print(ts_slip)
			if slip_status == True:
