...
save_to_csv(FILENAME,['RESET_POSITION_START',datetime.now().time() ]+get_joint_states_hand_only( kuka_allegro_hand_biotac, numJoints),'a')
...
save_to_csv(FILENAME,['RESET_POSITION_END',datetime.now().time() ]+get_joint_states_hand_only( kuka_allegro_hand_biotac, numJoints),'a')
